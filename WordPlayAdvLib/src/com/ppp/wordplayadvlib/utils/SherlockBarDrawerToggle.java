 ...
 */
public class SherlockBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private static class SherlockDrawerToggleImpl implements ActionBarDrawerToggleImpl {
        @Override
        public Drawable getThemeUpIndicator(Activity activity) {
            return SherlockDrawerToggleHoneycomb.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, SherlockFragmentActivity activity,
                Drawable themeImage, int contentDescRes) {
            return SherlockDrawerToggleHoneycomb.setActionBarUpIndicator(info, activity,
        ...
        public Object setActionBarDescription(Object info, SherlockFragmentActivity activity, int contentDescRes) {
            return SherlockDrawerToggleHoneycomb.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }
    ...
    static {
        IMPL = new SherlockDrawerToggleImpl();
    }
     ...
     *                                  for accessibility
     */
    public SherlockBarDrawerToggle(SherlockFragmentActivity activity, DrawerLayout drawerLayout,
